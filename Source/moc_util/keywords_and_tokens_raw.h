...
//===----------------------------------------------------------------------===//
	...
	INCLUDE_C_SHARED_KEYWORD("<<", LSHIFT)
	INCLUDE_C_SHARED_KEYWORD(">>", RSHIFT)

	// Relational operators
	INCLUDE_C_SHARED_KEYWORD("==", EQEQ)
	INCLUDE_C_SHARED_KEYWORD("!=", NOTEQ)
	INCLUDE_C_SHARED_KEYWORD(">", RANGLE)
	INCLUDE_C_SHARED_KEYWORD("<", LANGLE)
	INCLUDE_C_SHARED_KEYWORD(">=", GREATEREQ)
	INCLUDE_C_SHARED_KEYWORD("<=", LESSEQ)
...
//===----------------------------------------------------------------------===//
	...
	// C++
	// Relational operators
	INCLUDE_CPP_SHARED_KEYWORD_ALIAS("not_eq", NOTEQ_ALIAS)

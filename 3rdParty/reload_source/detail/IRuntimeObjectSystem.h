...
#include "generic_compile_options.h"
...
struct IRuntimeObjectSystem : public ITestBuildNotifier
{
    ...
    virtual void SetOptimizationLevel( reload::build::optimization_levels optimizationLevel_,	unsigned short projectId_ = 0 ) = 0;
    virtual reload::build::optimization_levels GetOptimizationLevel(					unsigned short projectId_ = 0 ) = 0;

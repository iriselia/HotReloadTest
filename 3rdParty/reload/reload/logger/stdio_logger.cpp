...
namespace reload
{
  ...
  namespace logging
  {
    ...
    void stdio_logger::LogError(const char * format, ...)
    {
      va_list args;
    ...
    void stdio_logger::LogWarning(const char * format, ...)
    {
      va_list args;
      va_start(args, format);
      LogInternal(format, args);
    ...
    void stdio_logger::LogInfo(const char * format, ...)
    {
      va_list args;
      va_start(args, format);
      LogInternal(format, args);
    }
    void stdio_logger::LogInternal(const char * format, va_list args)
    {
